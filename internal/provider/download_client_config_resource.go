...
func (c *DownloadClientConfig) write(downloadClientConfig *lidarr.DownloadClientConfig) {
...
func (c *DownloadClientConfig) read() *lidarr.DownloadClientConfig {
	return &lidarr.DownloadClientConfig{
