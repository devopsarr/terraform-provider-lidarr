...
func (r *RemotePathMapping) write(remotePathMapping *lidarr.RemotePathMapping) {
...
func (r *RemotePathMapping) read() *lidarr.RemotePathMapping {
	return &lidarr.RemotePathMapping{
		ID:         r.ID.ValueInt64(),
