		...
		Steps: []resource.TestStep{
			...
			// Create and Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("lidarr_notification_ntfy.test", "access_token", "testtoken123"),
			...
			// Update and Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					...
					resource.TestCheckResourceAttr("lidarr_notification_ntfy.test", "access_token", "testtoken234"),
				),
			},
			// ImportState testing
			{
