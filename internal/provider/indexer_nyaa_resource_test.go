		...
		Steps: []resource.TestStep{
			...
			// Create and Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("lidarr_indexer_nyaa.test", "base_url", "https://nyaa.org"),
					resource.TestCheckResourceAttrSet("lidarr_indexer_nyaa.test", "id"),
				),
			},
			// Unauthorized Create
			{
			...
			// Update and Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckResourceAttr("lidarr_indexer_nyaa.test", "base_url", "https://nyaa.net"),
				),
			},
			// ImportState testing
			{
				ResourceName:      "lidarr_indexer_nyaa.test",
				ImportState:       true,
...
func testAccIndexerNyaaResourceConfig(name, url string) string {
	return fmt.Sprintf(`
	resource "lidarr_indexer_nyaa" "test" {
