...
func TestAccDelayProfileResource(t *testing.T) {
	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			{
				Config: testAccTagResourceConfig("test", "delay-profile-resource") + testAccDelayProfileResourceConfig("usenet", "lidarr_tag.test.id"),
			...
			{
				Config: testAccTagResourceConfig("test", "delay-profile-resource") + testAccDelayProfileResourceConfig("torrent", "lidarr_tag.test.id"),
				Check: resource.ComposeAggregateTestCheckFunc(
