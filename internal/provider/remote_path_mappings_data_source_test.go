		...
		Steps: []resource.TestStep{
			...
			// Read testing
			{
				...
				Check: resource.ComposeAggregateTestCheckFunc(
					resource.TestCheckTypeSetElemNestedAttrs("data.lidarr_remote_path_mappings.test", "remote_path_mappings.*", map[string]string{"remote_path": "/test3/"}),
				),
			},
		},
	})
...
data "lidarr_remote_path_mappings" "test" {
}
`
