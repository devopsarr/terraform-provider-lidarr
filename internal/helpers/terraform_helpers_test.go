...
func TestDataSourceConfigure(t *testing.T) {
	...
	diags.AddError("Unexpected DataSource Configure Type", "Expected *lidarr.APIClient, got: string. Please report this issue to the provider developers.")
	...
	tests := map[string]struct {
		...
		"working": {
			expected: lidarr.NewAPIClient(lidarr.NewConfiguration()),
		},
		"nil": {
			expected: (*lidarr.APIClient)(nil),
		},
		"error": {
			expected:    "abc",
			errorString: diags,
...
func TestResourceConfigure(t *testing.T) {
	...
	diags.AddError("Unexpected Resource Configure Type", "Expected *lidarr.APIClient, got: string. Please report this issue to the provider developers.")
